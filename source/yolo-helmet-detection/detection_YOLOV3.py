...
# classesFile = "helmet/obj.names";
# modelConfiguration = "helmet/yolov3-obj.cfg";
# modelWeights = "helmet/yolov3-obj_2400.weights";
...
classesFile = objectName+"/obj.names";
modelConfiguration = objectName+"/yolov3-obj.cfg";
# modelWeights = objectName+"/yolov3-obj_2400.weights";
modelWeights = objectName+"/yolov3-obj_"+weight_version+".weights";
...
def postprocess(frame, outs):
    ...
    for i in indices:
        ...
        print("class id : %d, | class name : %d",classId, unknown_class)
    ...
    print("detect resule %d",count_person)
    if count_person >= 1:
...
for fn in glob('images/'+objectName+'/*.jpg'):
